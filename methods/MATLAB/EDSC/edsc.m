function [C] = edsc(X, lambda,affine,outlier,Dim,alpha)
...
% If you use this src in your research, please cite our paper:
...
% 		t1 = toc;
	...
	if(~affine) %linear
		% ALM
		%parameters
		epsilon = 1e-8; rho = 1e-6; maxIter = 30; eta = 3; max_rho = 1e10;
		%initialize
		C = zeros(N,N);
		D = zeros(d,N);
		E = zeros(d,N);
